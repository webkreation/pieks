      ...
      <Container maxW={"3xl"}>
        <Stack as={Box} textAlign={"center"} spacing={{ base: 8, md: 14 }} py={{ base: 10 }}>
          ...
          <Text color={"gray.500"} fontSize={{ base: "md", sm: "md", md: "lg" }}>
            ...
            Person übernehmen. Kostenpunkt: 2 Euro. Dann ist das Geld da, wenn die Impfung kommt.
            Für alle, für die eine Impfung nicht so selbstverständlich ist wie für uns. Und da
